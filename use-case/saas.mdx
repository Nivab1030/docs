---
title: "SaaS"
description: "How to Build SaaS Products with Kadabra"
icon: "laptop"
---

Welcome to the ultimate guide for building SaaS applications using Kadabra.dev.
...
<Steps>
  ...
  <Step title="Connect the Backend (Supabase)">
    ...
    **How**:
    ...
    - Press the Supabase button in the Kadabra editor
    ...
    <Info>
      You own your data and schema. Kadabra just simplifies setup.
    </Info>
  </Step>
  <Step title="Add Authentication">
    Kadabra adds email/password login by default. You can:
  ...
  <Step title=" Integrate AI (OpenAI)">
    ...
    **How**:
    ...
    - Add OpenAI API Key via Kadabra’s secure backend prompt
  ...
  <Step title="Add Payments with Stripe (Optional)">
    Kadabra supports **Stripe subscription payments** with edge functions.

    **How**:

    1. Create a Stripe product \+ price ID
    2. Add Stripe API Key to Kadabra
  ...
  <Step title="Deployment & Publishing">
    - Connect GitHub repo from Kadabra
    - Click “Publish” to launch on `.kadabra.app` domain
    - Use custom domain

    📌 Refer to [Kadabra Docs → Custom Domains](https://docs.kadabra.dev/tips-tricks/custom-domain) for full walkthrough.
  </Step>
  <Step title="Launch & Share">
    Submit to [Kadabra Launch](https://docs.kadabra.dev/features/launched) for visibility.
...
- [**AI Journaling App**](https://www.youtube.com/watch?v=gqsZGxuymTk&ab_channel=Kadabra): Users write daily logs and chat with an AI that gives feedback based on their mood and activity.
- [**AI Calorie Tracker**](https://www.youtube.com/watch?v=c0zhLzcVJRI&ab_channel=Kadabra): Users describe or upload meals, and GPT-4 estimates nutritional info and tracks weekly stats.
- [Luma Copycat:](https://www.youtube.com/watch?v=-sSOyO0FiPE) Luma-style event platform using Kadabra and [**Supabase**](https://docs.kadabra.dev/integrations/supabase)**.**
- [**Simple CRM**](https://www.youtube.com/watch?v=5ZL744_Wxjo)\*\*: \*\*Create a simple yet powerful CRM using [**Kadabra**](https://docs.kadabra.dev/kadabra-f9060f1e/kadabra-f9060f1e/editor/main#build-a-simple-crm-with-resend) for development, Supabase for data storage, and [**Resend**](https://docs.kadabra.dev/integrations/resend) for email automation.
- [Custom CRM:](https://www.youtube.com/watch?v=zv4vcR7VCAk) Create a **custom CRM** (Customer Relationship Management system) using [**Kadabra**](https://docs.kadabra.dev/kadabra-f9060f1e/kadabra-f9060f1e/editor/main#how-to-build-a-custom-crm-with-kadabra-and-make) and [**Make**](https://docs.kadabra.dev/integrations/make).
- [Custom CRM:](https://www.youtube.com/watch?v=tyAsNwu_xCI) Create a **custom CRM** (Customer Relationship Management system) using [**Kadabra**](https://docs.kadabra.dev/kadabra-f9060f1e/kadabra-f9060f1e/editor/main#clerk-authentication-custom-domains-and-waitlists) and [**Clerk**](https://docs.kadabra.dev/integrations/clerk).
- [Feedback tool:](https://www.youtube.com/watch?v=tYDqBMilHkM) Create a fully functional AI-powered feedback app.
- [DesignJoy copycat](https://www.youtube.com/watch?v=eZsbfEA-_oI&ab_channel=Kadabra): Create a productized agency platform from scratch\!
