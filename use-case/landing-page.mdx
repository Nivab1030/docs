---
title: "Landing Page"
description: "Welcome to the official guide to building landing pages in Kadabra. "
icon: "file"
---
...
Let Kadabra do the heavy lifting. Just write a single prompt and let the AI generate your entire landing page.
...
<Tip>
  Add specific audience, features, or tone to help Kadabra make better assumptions.
</Tip>
...
<Steps>
  ...
  <Step title="Step 2">
    Click into any section with [visual edits](https://docs.kadabra.dev/features/visual-edit) to:
  ...
  <Step title="Step 5">
    ...
    - **Launch on Kadabra Launch** (like Product Hunt but for Kadabra)

    <Tip>
      Increase visibility by submitting to [Kadabra Launch](https://docs.kadabra.dev/features/launched)
    </Tip>
  </Step>
</Steps>
...
Level up your landing page with Kadabra by adding rich interactive experiences, responsive UIs, and real working product previews.
...
<AccordionGroup>
  ...
  <Accordion title="Conversion Rate Optimization (CRO) 101">
    ...
    **CRO best practices:**
    ...
    Kadabra understands the term “CRO optimized,” so use it in your prompts.
  </Accordion>
  <Accordion title="Static vs Dynamic Pages">
    Kadabra builds static pages by default.
  ...
  <Accordion title="Final Polish = Razzle Dazzle">
    ...
    - Copywriting polish
    - Loading speeds
    - SEO setup (Kadabra now supports robots.txt and OG tags)
  </Accordion>
  <Accordion title="Add Real Product Previews">
    ...
    **Example:** A “Make it professional” email previewer powered by the GROQ API:
    ...
    - Use `chat mode` to help Kadabra understand and implement new APIs
  ...
  <Accordion title="Mobile Responsiveness">
    Kadabra auto-generates mobile-friendly pages—but test and tweak:
