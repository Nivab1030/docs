---
title: "Prototype"
description: "Build an application prototype with Kadabra"
icon: "pager"
---

## Kadabra Crash Course

<Steps>
  <Step title="Getting started with Kadabra 101">
    ...
    <AccordionGroup>
      <Accordion title="Setting Up Supabase">
        Supabase is an open-source database service built on PostgreSQL. It provides authentication, data storage, and file storage—perfect for our Kadabra integration.
      ...
      <Accordion title="Creating a Kadabra Project">
        Now, let’s set up a project in Kadabra.

        <Steps>
          <Step title="Start with a Fresh Blank Project">
            <Steps>
              <Step title="Step 1">
                Open Kadabra and create a **new project**.
              </Step>
              <Step title="Step 2">
                Keep your first prompt simple: _"Create a blank project"_.
              </Step>
              <Step title="Step 3">
                Kadabra will generate the basic structure for your app.
              </Step>
            </Steps>
          </Step>
          <Step title="Connect Supabase to Kadabra">
            <Steps>
              <Step title="Step 1">
                In Kadabra, navigate to the **database settings**.
              </Step>
              <Step title="Step 2">
                Enter your **Supabase project URL and API key**.
              </Step>
              <Step title="Step 3">
                Click **Connect** to link your Kadabra project to Supabase.
              </Step>
            </Steps>
          </Step>
        </Steps>
      ...
      <Accordion title="Adding a Login System">
        <Steps>
          ...
          <Step title="Apply SQL Changes for Authentication">
            <Steps>
              <Step title="Step 1">
                Kadabra will generate SQL for Supabase to handle authentication.
              </Step>
              <Step title="Step 2">
      ...
      <Accordion title=" Adding Notes (CRUD Functionality)">
        <Steps>
          <Step title="Set Up a Notes Table in Supabase">
            <Steps>
              <Step title="Step 1">
                Use Kadabra to generate SQL for a **Notes** table.
              </Step>
              <Step title="Step 2">
      ...
      <Accordion title="Debugging with Chat Mode">
        <Info>
          To enable [Chat Mode](https://docs.kadabra.dev/features/labs), go to **Settings \> Accounts Settings** tab.
        </Info>
        <Steps>
          <Step title="Identify Errors">
            - If an issue arises, enable **Chat Mode**.
            - Kadabra will analyze **Supabase logs** and **TypeScript errors**.
          </Step>
          <Step title="Apply Fixes">
            <Steps>
              <Step title="Step 1">
                Review Kadabra’s debugging suggestions.
              </Step>
              <Step title="Step 2">
  ...
  <Step title="Building Interactive UIs">
    ...
    <AccordionGroup>
      <Accordion title="Understanding Components">
        Components in Kadabra help organize UI elements into modular and reusable parts. Instead of having all UI elements in a single page (e.g., a 400-line dashboard), we break them into components such as:
        ...
        <Steps>
          ...
          <Step title="Refactor Into Components">
            Use Kadabra’s chat mode to scan the code and suggest an optimized structure.
          </Step>
      ...
      <Accordion title="Editing UI Efficiently">
        <Steps>
          ...
          <Step title="Use Chat Mode for Refactoring">
            Ask Kadabra to refactor large UI sections into smaller components.
        ...
        <Steps>
          <Step title="Using 21st.dev for UI Inspiration">
            <Steps>
              ...
              <Step title="Step 2">
                Choose a design, copy its prompt for Kadabra, and integrate it into your project.
              </Step>
            </Steps>
          </Step>
      ...
      <Accordion title="Redesigning the Dashboard">
        ...
        <Steps>
          ...
          <Step title="Step 2">
            **Screenshot the relevant section** and upload it to Kadabra.
          </Step>
          <Step title="Step 3">
