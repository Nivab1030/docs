---
title: "Glossary"
description: "Learn the key development terms you need to navigate and use Kadabra effectively."
icon: "bookmark"
---
...
* [**Prompt**](https://docs.kadabra.dev/tips-tricks/prompting)**:** A piece of text or input that guides AI models in generating outputs or performing certain tasks.​ It is within the core functionality of Kadabra and it is with prompts that you create, modify a specific component or element in your application.

## Kadabra-Specific Terms

* [**Chat Mode**](https://docs.kadabra.dev/features/labs#chat-mode)**:** Kadabra goes beyond just generating code; it becomes an interactive assistant guiding you through every phase of development. It helps founders think critically, plan effectively, debug intelligently, and ship confidently.

* **Edit Mode**: The action of making changes or modifications to content or code.​

* [**Edit**](https://docs.kadabra.dev/features/precision-edit#visual-edits)**:** A tool that allows AI-driven development with Tailwind-native visual controls for easy refinement.

* **History:** The system of tracking and managing changes to your app and code over time.​

* [**Knowledge**](https://docs.kadabra.dev/features/precision-edit#knowledge-files)**:** Capture essential project details in a living document that evolves with your app.

* [**Labs**](https://docs.kadabra.dev/features/labs)**:** Experimental features within Kadabra dedicated to testing and showcasing new, innovative, or in-development functionalities.​ These might be modified or be removed at any time.
...
* [**Builder.io:**](https://kadabra.dev/blog/2025-01-22-figma-to-kadabra-builder-io-native-integration) Integration that enables users to export Figma designs directly into Kadabra to build full-stack apps without coding.
...
* [**Supabase**](https://docs.kadabra.dev/integrations/supabase)**:** An open-source backend-as-a-service platform that provides a Postgres database, authentication, instant APIs, and real-time capabilities.&#x20;
