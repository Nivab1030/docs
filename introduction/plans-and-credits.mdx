...
description: "Understanding plans, credit usage and credit rollovers in Kadabra"
icon: "money-bill-wave"
---

Kadabra is a subscription based service with a free plan and several paid plans. When you pay for a subscription you get access to more features, and more credits. You need credits to send messages in Kadabra.
...
- Private projects
- Ability to connect custom domains to your Kadabra projects
- Ability to remove the "Edit with Kadabra" badge from your Kadabra projects
- Access to Code mode to edit code directly inside of Kadabra
...
Kadabra has a usage-based credit system, where sending messages deducts credits. 
...
This approach allows for more precise edits and greater efficiency per message, making Kadabra more affordable overall.
...
For detailed information about subscription options, visit our [pricing page](https://kadabra.dev/pricing).

## FAQ

<AccordionGroup>
  <Accordion title="What is a credit?">
    Credits are used when sending messages in Kadabra.
  </Accordion>
...
<AccordionGroup>
  ...
  <Accordion title="I've paid but still don't have access to my plan. What should I do?">
    Please reach out to support on [support@kadabra.dev](mailto:support@kadabra.dev).
  </Accordion>
</AccordionGroup>
