...
Kadabra’s Visual Edits allows you to select elements on the page and either edit them instantly, such as updating text or colors, or use prompts to adjust functionality and layout. This tool is useful for making quick, targeted updates without needing to modify the code manually or use the AI.
...
<Steps>
  ...
  <Step title="Apply and Review">
    Once your change is made, click **Save** and Kadabra will instantly update the live preview and code.
  </Step>
</Steps>
