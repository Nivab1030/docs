...
**Search Engine Optimization (SEO)** helps your pages rank higher on Google and other search engines, making them more discoverable. Kadabra includes comprehensive SEO optimizations automatically in every page and component you create.
This guide outlines what Kadabra does automatically and how to further optimize your Kadabra-generated pages for search engines.

## Automatic SEO Features
Kadabra includes these SEO optimizations out of the box for all new pages:
...
## Built-in Page Speed Optimization
    Kadabra includes built-in page speed optimization powered by Google Lighthouse, an open-source tool that analyzes your page's performance, accessibility, SEO, and best practices.
...
<AccordionGroup>
  <Accordion title="Sitemap for Search Engine Indexing">
    ...
    **How to Generate a Sitemap in Kadabra:**

    <Steps>
      <Step title="Step 1">
        Ask Kadabra to **"Create a sitemap with my custom domain"**.
      </Step>
      <Step title="Step 2">
  ...
  <Accordion title="Robots.txt Configuration for Search Control">
    The `robots.txt` file tells search engines which pages they should or shouldn’t crawl. Kadabra can create and customize this file for you.

    **Steps to Add a robots.txt File:**

    <Steps>
      <Step title="Step 1">
        Prompt Kadabra to **"Generate a robots.txt file for my site."**
      </Step>
      <Step title="Step 2">
  ...
  <Accordion title="Internal Linking for Better SEO">
    Internal links help users and search engines navigate your site. Kadabra can:
    ...
    **How to Add Internal Links in Kadabra:**
    ...
    <AccordionGroup>
      ...
      <Accordion title="Manually Update via GitHub">
        <Steps>
          ...
          <Step title="Step 2">
            Connect your project to GitHub if you haven’t already. Follow our [GitHub integration guide](https://docs.kadabra.dev/integrations/git-integration).
          </Step>
          <Step title="Step 3">
...
<AccordionGroup>
  ...
  <Accordion title="Does Kadabra optimize for mobile SEO?">
    Yes\! Kadabra ensures mobile-friendly page structures automatically.
  </Accordion>
</AccordionGroup>