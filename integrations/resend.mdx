...
description: "Learn how to integrate Resend with your Kadabra application"
icon: "envelope"
---
...
- **Kadabra**: to generate the front end and backend logic.
...
<Steps>
  <Step title="Create a Landing Page with a Contact Form">
    Use Kadabra's AI to quickly generate a landing page for your product or service.

    **Instructions:**

    <Steps>
      <Step title="New Kadabra Project">
        Create a new Kadabra project.
      </Step>
      <Step title="Prompt:">
        <Info>
          Create a SaaS landing page with a contact form collecting name, email, and message.
        </Info>
        ![Landing Page Kadabra Project Pn](/images/landing-page-kadabra-project.png)
      </Step>
  ...
  <Step title="Store Form Submissions in Supabase">
    ...
    <Steps>
      ...
      <Step title="API Key">
        In Kadabra, connect your Supabase project using the API key.
  ...
  <Step title="Send Confirmation Emails via Resend">
    ...
    <Steps>
      ...
      <Step title="API Key">
        Integrate the API key in Kadabra via environment settings or backend function.
      </Step>
      <Step title="SDK">
  ...
  <Step title="Build a Secure Admin Dashboard">
    ...
    <Steps>
      <Step title="Admin route">
        Create an `/admin` route in Kadabra.
      </Step>
  ...
  <Step title="Final Touches & Best Practices">
    ...
    - **Error Handling**: Kadabra might show build errors that are false positives. Always test your functionality live.
    - **Reverting with Supabase**: If reverting code in Kadabra, remember to manually delete associated Supabase policies or migrations—they're not rolled back automatically.
    - **Deliverability Tips**:
