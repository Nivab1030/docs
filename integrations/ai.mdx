...
description: "How to Integrate AI Services into Kadabra Projects"
icon: "wand-magic-sparkles"
---

Kadabra makes it easy to integrate AI services into your web applications. Whether you want to build an AI-powered landing page, a text-generation tool, or a full SaaS app, Kadabra's built-in integrations with services like 
...
<Steps>
  ...
  <Step title="Plan with Prompts First">
    Use Kadabra's chat interface to describe your feature in simple terms. For example:
    ...
    Kadabra will scaffold the UI, suggest components, and let you preview the app quickly.
  </Step>
  ...
  <Step title="Use Edge Functions for AI Calls">
    To safely call AI APIs, create an Edge Function inside Kadabra:

    - Add your API key to the Supabase by submitting this via the secrets form
    - Let Kadabra generate the edge function code
  ...
  <Step title="Publish and Promote">
    ...
    - Use [Kadabra Launch](https://docs.kadabra.dev/features/launched) to get visibility
...
- Use screenshots when asking Kadabra to debug a layout.
...
<AccordionGroup>
  ...
  <Accordion title="Edge Function fails silently?">
    View Edge Function logs in Kadabra's function editor or Supabase dashboard.
  </Accordion>
</AccordionGroup>

## Example Projects Built with AI Integration

- [**Nexus Smart Email** ](https://smart-email-nexus.kadabra.app/)– Landing page with real-time Groq-enhanced email preview
- [**TweetMixer Pro**](https://www.youtube.com/watch?v=fT_dq_hyQAA&vl=de) – Paste blog posts, get tweet threads using GPT-4
- [**AI Calorie Tracker**](https://www.youtube.com/watch?v=c0zhLzcVJRI&ab_channel=Kadabra) – Analyze meals via GPT-4 with image uploads
...
Kadabra is your AI-powered frontend, database, backend, and deployment pipeline all-in-one. AI integration is just prompting \+ context \+ testing. Take it step-by-step, and remember: you don’t need to be a backend engineer to build with AI.