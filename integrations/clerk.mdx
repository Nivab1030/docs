...
description: "Learn how to integrate Clerk with your Kadabra application"
icon: "people-arrows"
---
...
<Steps>
  <Step title="Set Up Your Clerk App" stepNumber="1">
    <Steps>
      ...
      <Step title="Step 3">
        **Add Clerk to Your Kadabra App**

        <Steps>
          <Step title="Step 1">
            In **Kadabra**, add Clerk as your authentication provider.
            ...
            ![Asana Clone Kadabra Pn](/images/asana-clone-kadabra.png)
          </Step>
          <Step title="Step 2">
            Paste your **Public API Key** when asked
          </Step>
          <Step title="Step 3">
            Kadabra scaffolds the login and sign-up pages
  ...
  <Step title="Add a Custom Domain (Optional)" stepNumber="6">
    <Note>
      **Why use a custom domain?**
      ...
      [More information here](https://docs.kadabra.dev/tips-tricks/custom-domain).
    </Note>
    <Steps>
      <Step title="Step 1">
        In Kadabra: **Settings \> Custom Domain**

        ![Custom Domain Kadabra Pn](/images/custom-domain-kadabra.png)
      </Step>
      <Step title="Step 2">
        Enter your purchased domain (e.g. `app.yourcompany.com`)
      </Step>
      <Step title="Step 3">
        Kadabra auto-configures DNS (no need to leave Kadabra)
      </Step>
      <Step title="Step 4">
...
Want a question added to this FAQ? [Let us know on Discord](https://discord.gg/kadabra-dev)\!
