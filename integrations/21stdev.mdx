...
description: "Build High-Converting AI Landing Pages Using Kadabra"
icon: "ruler-combined"
---
...
We are going to share a structured workflow using Kadabra and 21stdev that creates landing pages clients _actually_ love (like [this one](https://kadabra.dev/projects/35d72d2e-6e25-40e5-9b0c-c0d1a7c1b727)).
...
<Steps>
  ...
  <Step title="Start with a blank project">
    Start your Kadabra project by prompting:
  ...
  <Step title="Convert WebP to PNG and Prep Your Design Screenshot ">
    Once you find your reference design, download it. If it saves in WebP format, use an online converter to change it to PNG so it can be easily used in Kadabra or GPT workflows.
  ...
  <Step title="Turn Inspiration into a Detailed Prompt Using Chat Mode">
    Use Kadabra [Chat Mode](https://docs.kadabra.dev/features/labs#chat-mode) to extract:
    ...
    <Info>
      Kadabra [Chat mode](https://docs.kadabra.dev/features/labs#chat-mode) (or customGPT) is also trained to recommend Unsplash images for blog thumbnails and illustrations.
    </Info>
    <Warning>
      Kadabra occasionally mislabels things (e.g., "Space Grotesque" font was misspelled). Always review and correct prompt outputs before pasting into Kadabra.
    </Warning>
    You can even ask Kadabra chat mode to elaborate on sections or rewrite the prompt with better UX suggestions.
  </Step>
  <Step title=" Generate the First Draft with Kadabra">
    Paste the detailed prompt into Kadabra Edit Mode. Then:
    ...
    <Info>
      Please note how much Kadabra faster this feels compared to setting up Tailwind or Bootstrap manually just a year ago.
    </Info>
  </Step>
  <Step title="Edit in Real Time: Visual + Text Prompts">
    Use Kadabra’s [visual editing tool](https://docs.kadabra.dev/features/visual-edit) to:
  ...
  <Step title="Polish the Design with 21stdev Components">
    ...
    Find a component you like, copy the prompt, and paste it into Kadabra. Be sure to match the visual tone with the rest of the site.
  </Step>
  <Step title="Fix AI Misinterpretations">
    ...
    - Adjust branding (Kadabra defaults to blue)
  ...
  <Step title="Add Light Animations and Microinteractions">
    ...
    Kadabra can integrate [Framer Motion](https://motion.dev/) out-of-the-box if prompted right.
  ...
  <Step title="Generate Custom Visuals with AI (Optional)">
    ...
    **Steps:**
    ...
    <Steps>
      ...
      <Step title="Remove the background, then reinsert into Kadabra">
  ...
  <Step title="Share with Clients & Iterate">
    ...
    You can continue refining sections using Kadabra’s visual or prompt-based editor. It’s a fast iteration loop.
  </Step>
</Steps>
...
- Use structured prompts with Kadabra Chat Mode
...
This is the workflow [Prajwal](https://x.com/PrajwalTomar_/status/1902371273147064772) uses everyday for his clients - that we tried in-house - to build fast, beautiful, high-converting landing pages—powered by Kadabra AI but guided by intention.
