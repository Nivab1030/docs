...
description: "How to Bring Your Vision to Life with Kadabra"
...
- Use Kadabra the smart way—especially if you’re not a developer
...
### 1. Start Outside Kadabra

Many builders—including livestream guest MP—spend time shaping their ideas _before_ opening Kadabra.
...
Use Kadabra when you're ready to go from clear vision to working prototype.
...
There are two valid approaches to building with Kadabra:
...
<Tip>
  Kadabra now reads console logs automatically—no copy-paste needed for most cases.
</Tip>
...
[MP](https://www.youtube.com/watch?v=mwHNw8aeYCI&ab_channel=Kadabra) built 100\+ throwaway projects:
...
> Kadabra will help with the rest.