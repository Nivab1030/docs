---
title: "Using images in Kadabra"
description: "Learn how to add images to your Kadabra projects"
icon: "frame"
---
...
<AccordionGroup>
  <Accordion title="Upload the image to the prompt chat">
    Simply upload them in the chat and explain to Kadabra’s AI where and how you’d like them to appear in your project.
  ...
  <Accordion title="Replace it on the visual editor">
    You can replace an existing image directly using the [visual editor](https://docs.kadabra.dev/features/precision-edit#visual-edits) functionality: 
  ...
  <Accordion title="Using an external image URL">
    ...
    Here’s how to prompt Kadabra to use an external image:
    ...
    <Steps>
      ...
      <Step title="Step 2">
        In your project prompt, simply tell Kadabra to use that image by specifying the URL. For example:
  ...
  <Accordion title="Using images from your GitHub public directory">
    Another method to add images to your Kadabra project is by using images uploaded to the `public` directory of your connected GitHub repository. Here’s how you can do it:

    <Steps>
      <Step title="Connect your GitHub repository">
        Ensure your project is connected to your GitHub repo. [Here's how to connect your repo](https://docs.kadabra.dev/integrations/git-integration).
      </Step>
      ...
      <Step title="Get the image path">
        Once the file is uploaded, select it and then click on the copy icon next to the file name to copy the image’s path. This path will be used in your Kadabra prompt.
        ![Selecting files for upload](/assets/using-images-github-selecting.png)
      </Step>
      <Step title="Use the image in Kadabra">
        ...
        <Warning>
          Uploading large images to your GitHub repo can cause it to grow in size, which can affect Kadabra performance (longer repo cloning times, slower startup of previews/sandbox).
    ...
    To help you better understand how to integrate images using the methods outlined above, we have a project you can explore: [Kadabra Project Example](https://kadabra.dev/projects/e823fedf-238d-4313-86a8-1fd4bfc2a9ba). In this project, you can see the actual prompts and how each method works in practice.
