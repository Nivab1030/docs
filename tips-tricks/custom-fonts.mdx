...
description: "Learn how to use web-safe fonts and Google Fonts in your Kadabra projects"
icon: "font"
---

Currently, Kadabra does not support direct uploads of custom fonts. 
...
<AccordionGroup>
  ...
  <Accordion title="Using Google Fonts">
    If you prefer to use custom fonts, Kadabra works nicely with **Google Fonts**. This allows you to easily use a wide range of fonts in your project. You can either reference a Google font by name or by linking directly to the font resource.

    ### Using by name

    In your prompt, you can specify the name of a Google font, and Kadabra will include it in your project. For example:
    ...
    Alternatively, you can provide a direct link to the Google font, and Kadabra will use that font in your project. You can get the link from [Google Fonts](https://fonts.google.com) by selecting the desired font and copying the link.

    Here’s how to prompt Kadabra to use a Google font via a link:
    ...
    By following these methods, you can customize the typography of your Kadabra project using either web-safe fonts or Google Fonts.

    ## Further learning and examples

    To see these font integration methods in action, you can explore one of our example projects: [Kadabra using fonts example project](https://kadabra.dev/projects/3a826f38-d9cb-4d60-b4da-30a9b00149c8).
    ...
    <Frame>
      ![Different fonts used in Kadabra project](/assets/using-custom-fonts-example.png)
    </Frame>
