...
description: "Getting the Most Out of Kadabra"
icon: "dumbbell"
---

This guide helps all users—new or experienced—get up to speed quickly and avoid common pitfalls when building on Kadabra.

## 1. Set Your Foundation: Use the Knowledge File

**Why it matters:** The [_Knowledge_](https://docs.kadabra.dev/features/knowledge) file is your project’s brain. It gets sent with every prompt and helps the AI understand the full context.
...
## 2. [Prompting](https://docs.kadabra.dev/tips-tricks/prompting-one) Best Practices
...
[**Chat mode**](https://docs.kadabra.dev/features/labs#chat-mode) = your AI co-pilot. It helps you debug, brainstorm, and plan implementations—without editing your code until you’re ready.
...
**Heads-up:** [Supabase](https://docs.kadabra.dev/integrations/supabase) does not revert cleanly. If you revert a version, your database schema may break.
...
The [**Visual Edit tool**](https://docs.kadabra.dev/features/visual-edit) is free and fast. Use it instead of prompts for:
...
## 6. Use [GitHub](https://docs.kadabra.dev/integrations/git-integration) \+ Version Control Wisely
...
- Use **GitHub branching** at your own risk. Avoid deleting branches before switching back to `main` in Kadabra to prevent project sync issues.

## 7. When All Else Fails, Remix

Many users realize: doing it all over takes less time the second time.

- [Remix](https://docs.kadabra.dev/user-guides/quickstart#remix-an-existing-project:~:text=you%20to%20reuse-,the,-current%20state%20of) creates a clean copy of your project at T=0.
...
- [Documentation](https://docs.kadabra.dev) contains walkthroughs, templates, SEO tips, integrations, and more. You can ask questions directly in the doc AI assistant.
- Join the [Discord community](https://discord.gg/kadabra-dev) for peer support.
- When ready, submit your project to [Kadabra Launch](https://docs.kadabra.dev/features/launched).
