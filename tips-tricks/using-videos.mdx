...
Kadabra offers two methods for embedding videos into your projects. Below, we’ll cover both options step by step:
...
<AccordionGroup>
  ...
  <Accordion title="Using a video from your GitHub public folder">
    <Warning>
      Uploading large videos to your GitHub repo can cause it to grow in size, which can affect Kadabra performance (longer repo cloning times, slower startup of previews/sandbox).
    ...
    <Steps>
      <Step title="Connect your GitHub repository ">
        First, make sure your project is linked to a GitHub repo. [Here’s how to set up your repo](https://docs.kadabra.dev/integrations/git-integration).
      </Step>
      ...
      <Step title="Reference the video in Kadabra">
    ...
    To see these methods in action, explore one of the example projects: [Kadabra using videos example project](https://kadabra.dev/projects/380835ab-c8d7-4f45-9b0d-51ec04294457). You’ll find real prompts demonstrating how videos are integrated using both methods.
